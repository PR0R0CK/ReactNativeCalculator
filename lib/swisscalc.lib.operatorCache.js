...
//method for 10^x
global.swisscalc.lib.operatorCache.TenPowerOperator = new global.swisscalc.lib.operator(
	global.swisscalc.lib.operator.ARITY_BINARY, global.swisscalc.lib.operator.ASSOCIATIVITY_RIGHT, 4, 2, false, false, function(sy) {
		var op = sy.popOperand();
		return Math.pow(10, op);
});

//method for factorial
global.swisscalc.lib.operatorCache.FactorialOperator = new global.swisscalc.lib.operator(
	global.swisscalc.lib.operator.ARITY_BINARY, global.swisscalc.lib.operator.ASSOCIATIVITY_RIGHT, 4, 2, false, false, function(sy) {
		var op = sy.popOperand();
		return Math.factorial(10, op);
});
